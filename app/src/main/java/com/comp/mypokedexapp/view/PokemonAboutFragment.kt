...
import com.comp.mypokedexapp.databinding.FramentPokemonAboutBinding
import java.util.*

class PokemonAboutFragment  : Fragment(){
    
    private var _binding: FramentPokemonAboutBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FramentPokemonAboutBinding.inflate(inflater, container, false )
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        pokemon.let {
            ...
            binding.txtAbilities.text = when(it.abilities.size){
                ...
                2 -> "${captalizerText(it.abilities[0].name)}, ${captalizerText(
                    it.abilities[1].name
                )
                }"
                else -> ""
...
fun weaknessPokemon(type: String): List<String> = when (type){
    ...
    "water" -> listOf("water", "ground", "rock")

    "grass" -> listOf("fire", "fighting","rock", "steel" )
