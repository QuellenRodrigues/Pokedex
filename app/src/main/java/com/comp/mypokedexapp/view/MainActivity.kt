package com.comp.mypokedexapp.view
...
import com.comp.mypokedexapp.api.model.PokemonModel
import com.comp.mypokedexapp.domain.Pokemon
import com.comp.mypokedexapp.viewModel.PokemonViewModel
import com.comp.mypokedexapp.viewModel.PokemonViewModelFactory
...
class MainActivity : AppCompatActivity() {
    ...
    private var filterArrayAleatory: ArrayList<Pokemon> = ArrayList()
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        fab.setOnClickListener({
            ...
            if (this::tempArrayList.isInitialized){
                val intent = Intent(this@MainActivity, PokemonActivity::class.java)
                val poke = PokemonModel(
                    tempArrayList[rnds]!!.id,
                    tempArrayList[rnds]!!.name,
                    tempArrayList[rnds]!!.imageUrl,
                    tempArrayList[rnds]!!.types,
                    tempArrayList[rnds]!!.weight,
                    tempArrayList[rnds]!!.height,
                    tempArrayList[rnds]!!.base_experience,
                    tempArrayList[rnds]!!.abilities,
                    tempArrayList[rnds]!!.species,
                    tempArrayList[rnds]!!.biography,
                    tempArrayList[rnds]!!.base_happiness,
                    tempArrayList[rnds]!!.capture_rate,
                    tempArrayList[rnds]!!.growth_rate,
                    tempArrayList[rnds]!!.evolutions,
                    tempArrayList[rnds]!!.stats
    ...
    private fun adapterInRecyclerViewAleatory(pokemons: List<Pokemon?>) {

        val adapter = PokemonAdapter(pokemons)
        var ramdomValues = List(1){ Random.nextInt(0,50)}
        var positions = ramdomValues.toString().length
        ...
        adapter.setOnItemClickListener(object : PokemonAdapter.onItemClickListener {
            override fun onItemClick(position: Int) {
                ...
                val poke = PokemonModel(
                    pokemons[positions]!!.id,
                    pokemons[positions]!!.name,
                    pokemons[positions]!!.imageUrl,
                    pokemons[positions]!!.types,
                    pokemons[positions]!!.weight,
                    pokemons[positions]!!.height,
                    pokemons[positions]!!.base_experience,
                    pokemons[positions]!!.abilities,
                    pokemons[positions]!!.species,
                    pokemons[positions]!!.biography,
                    pokemons[positions]!!.base_happiness,
                    pokemons[positions]!!.capture_rate,
                    pokemons[positions]!!.growth_rate,
                    pokemons[positions]!!.evolutions,
                    pokemons[positions]!!.stats
